...
lmt=anat/sub-NDARINV003RTV85_ses-baselineYear1Arm1_hemi-L_space-MNI_mesh-fsLR32k_midthickness.surf.gii
rmt=anat/sub-NDARINV003RTV85_ses-baselineYear1Arm1_hemi-R_space-MNI_mesh-fsLR32k_midthickness.surf.gii
...
singularity run \
    ...
    -B ${MRE}:/matlab/                      \
    -B config_smooth.json:/config.json      \
    ...
    crossotope.sif analysis                 \
        ...
        --label         test_newargs_smooth1        \
        --midthickness  /session/{${lmt},${rmt}}    \
